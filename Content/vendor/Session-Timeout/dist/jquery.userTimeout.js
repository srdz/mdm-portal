	...
	$.fn.userTimeout = function (opts) {
		...
		var modal = function () {
			...
			if ($modalUI === 'bootstrap') {
                ...
                $dialog = $('<div class="modal-dialog modal-dialog-centered" role="document"></div>');
				...
				if ($options.timer === true) {
                    $footer = $('<div class="modal-footer"><button type="button" class="btn btn-session-timeout" data-dismiss="modal">' +  $options.modalStayLoggedBtn + ' (<span id="countdowntimer">' + $countDownTimer + '</span>)</button></div>');
				} else {
					$footer = $('<div class="modal-footer"><button type="button" class="btn btn-session-timeout" data-dismiss="modal">' +  $options.modalStayLoggedBtn + '</button></div>');
				}
